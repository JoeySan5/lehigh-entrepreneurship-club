    ...
    <div>
      ...
      >
        <style type="text/css">
          ...
          .animate-opacity.start-animation {
            opacity: 1;
          }
          ...
          .animate-translate.start-animation {
        ...
        <g>
          <g id="ezh40FSqd2D4" transform="translate(.000003-562.04657)">
            <circle className="st1 animate-opacity" cx="1748.2" cy="668.6" r="3" />
            <circle className="st1 animate-opacity" cx="1080.9" cy="570.6" r="3" />
            <circle className="st1 animate-opacity" cx="1277.8" cy="376.5" r="3" />
            <circle className="st1 animate-opacity" cx="1631.7" cy="109.9" r="3" />
            <circle className="st1 animate-opacity" cx="1898.2" cy="208.6" r="3" />
            <circle className="st1 animate-opacity" cx="1748.2" cy="668.6" r="3" />
            <circle className="st1 animate-opacity" cx="1946.3" cy="501.1" r="3" />
            <circle className="st1 animate-opacity" cx="1946.3" cy="501.1" r="3" />
            <circle className="st1 animate-opacity" cx="276" cy="84" r="3" />
            <circle className="st1 animate-opacity" cx="417" cy="276" r="3" />
            <circle className="st1 animate-opacity" cx="512" cy="514" r="3" />
            <circle className="st1 animate-opacity" cx="173" cy="293" r="3" />
            <circle className="st1 animate-opacity" cx="834.9" cy="568.4" r="3" />
            <circle className="st1 animate-opacity" cx="862.7" cy="167.2" r="3" />
            <circle className="st1 animate-opacity" cx="1120.9" cy="80.6" r="3" />
            <circle className="st1 animate-opacity" cx="728" cy="359" r="3" />
            <circle className="st1 animate-opacity" cx="1631.7" cy="109.9" r="3" />
            <circle className="st1 animate-opacity" cx="1898.2" cy="208.6" r="3" />
          </g>
          ...
          <path className="st2 animate-translate" d="M1417.1,420.6L1417.1,420.6z" />
          <path className="st2 animate-translate" d="M1477,403.3L1477,403.3z M1417.1,403.3L1417.1,403.3z M1451.2,403.3L1451.2,403.3z" />
          <path className="st2 animate-translate" d="M1417.1,423.2L1417.1,423.2z M1477,423.2L1477,423.2z M1451.2,423.2L1451.2,423.2z M1417.1,440.4L1417.1,440.4
		...
		c0,3.8-3.1,6.8-6.8,6.8H1424c-3.8,0-6.8-3.1-6.8-6.8v-14.2h76.7L1493.9,454.6L1493.9,454.6z M1521.7,351.6... c-17.8,19.6-27.6,45.1-27.8,71.5H1477l0.4-90h11.5c15.8,0,28.6-12.8,28.7-28.6s-12.7-28.7-28.6-28.7s-28.7,12.7-28.8,28.5v0.1v11.5... h-9.4v-11.5c0-0.1,0-0.1,0-0.2c-0.1-15.8-13-28.5-28.8-28.5s-28.6,12.9-28.5,28.7s12.9,28.6,28.7,28.6h11.5l0.4,90h-16.8
		...
		c-6.3,0-11.4-5.1-11.4-11.4s5.1-11.4,11.4-11.4s11.4,5.1,11.4,11.4v0.2L1433.5,315.9L1433.5,315.9z" />
            ...
            <path className="st3 animate-opacity" d="M1456.6,621.3c-10.5-9.3-73.5-66.9-52.5-131.7c2.7-8.2,6.5-16.1,11.2-23.3h82.9c4.5,7.6,7.9,15.7,10.3,24.1
			C1526.6,554.9,1468.8,610.1,1456.6,621.3L1456.6,621.3z" />
            <path className="st2 animate-opacity" d="M1456.2,547.3c-4.6-4.9-32.1-35-23-68.8c1.2-4.2,2.8-8.3,4.9-12.2h36.3c2,4,3.5,8.3,4.5,12.6
			C1486.8,512.6,1461.5,541.4,1456.2,547.3L1456.2,547.3z" />
        
        
          <path className="st4 animate-translate" d="M483,815v36.1c-3.3-11.4-5-23.2-5-35.1c0-0.3,0-0.7,0-1H483z" />
          <path className="st4 animate-translate" d="M2165.8,678v479H64.8V588l0,0c0-0.2,0-0.3,0-0.5c0-54.4,38.3-101.4,91.7-112.2s107,17.4,128.2,67.5
		...
		C2115.8,546.8,2165.9,607.4,2165.8,678z" />
          <path className="st4 animate-translate" d="M483,815v36.1c-3.3-11.4-5-23.2-5-35.1c0-0.3,0-0.7,0-1H483z" />
          <path className="st4 animate-translate" d="M478,815h5v36.1c-3.3-11.4-5-23.2-5-35.1C478,815.7,478,815.3,478,815z" />
          <path className="st4 animate-translate" d="M728,815v1C728,815.7,728,815.3,728,815z" />
       
        
          <path className="st5 animate-opacity" d="M2161.9,1081.1c0-50.2-41.1-91.2-90.5-91.2c-58,0-90.5,56.5-90.5,91.6c0,1.7,0,3.4,0.1,5
		c-18.2,5-35.1,14-49.4,26.3c-12.2-14.2-30-22.4-48.7-22.5c-35.7,0-64.7,29.3-64.7,65.4c0,2,0.1,4,0.3,6c-13.7-3.7-27.8-5.5-42-5.5... c-62.6,0-117,35.8-144.2,88.4c-24.4-12.3-53.4-11.9-77.4,1.1c-12-41.9-50.1-72.6-95.4-72.6c-30.2,0-58.7,13.9-77.4,37.6
		...
		c-0.4-59.5-48.7-107.6-108.2-107.8S62.6,903.2,61.9,962.7c0,0.2,0,0.3,0,0.5v450.5h2100C2161.9,1302.8,2161.9,1192,2161.9,1081.1z
		 M328.9,1244.7h-0.7l0.7-0.5V1244.7z M1939.1,1319.2v-0.4c0.2,0.2,0.4,0.3,0.6,0.4H1939.1z" />
          <path className="st5 animate-opacity" d="M0,782c0,0.2,0,0.3,0,0.5V782z" />
