...
export default function Test() {
  const svgRef = useRef<SVGSVGElement>(null); // Correctly type the ref
    ...
    <div>
      ...
      >
        <style type="text/css">
          ...
          .st4{fill:#F2F2F2;}
          .st5{fill:#CED5E0;}
          .stopColor1 { stopColor: #2E3192; }
          .stopColor2 { stopColor: #001336; }`}
        </style>
        <linearGradient
          id="SVGID_1_"
        ...
        >
          <stop offset="0" className="stopColor1" />
          <stop offset="1" className="stopColor2" />
        </linearGradient>
        ...
        <g id="ezh40FSqd2D49" transform="matrix(1.410651 0 0 1.410651-707.660507-275.139485)">
          ...
          c27.1,0,53.4,8.7,75,25c0.4-46.9,27-89.7,69-110.8s92.2-16.8,130,11c6.2-25.6,26.1-45.7,51.6-52.1s52.6,1.8,70.2,21.4... c35.8-37.5,85.4-58.6,137.2-58.6c4,0,8,0.1,12,0.4V698c0-21.7,9.4-42.3,25.8-56.6s38.1-20.7,59.6-17.7c26-65.6,95-103.5,164.3-90.2
